...
# def test_create_transaction(db, group_data, user_data, category_data, expenses_data, journal_data,account_data, transaction_data):
...
#     db.session.commit()
    ...
    # transaction = TransactionModel(amount=transaction_data['amount'],type=transaction_data['type'], entry_id=transaction_data['entry_id'], target_account=transaction_data['target_account'],target_user=transaction_data['target_user'], group=transaction_data['group'])

    # db.session.add(transaction)
    # db.commit()

    # expected =  120.00
    # actual = TransactionModel.query.get(1).amount

    # assert actual  == expected


# def test_delete_transaction(db, group_data, user_data, category_data, expenses_data, journal_data):
...
# def test_update_transaction(db, group_data, user_data, category_data, expenses_data, journal_data):
